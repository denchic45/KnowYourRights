...
import com.denchic45.knowyourrights.databinding.FragmentQuizResultsBinding
...
class QuizResultsFragment : BaseFragment<QuizResultsViewModel, FragmentQuizResultsBinding>(
    R.layout.fragment_quiz_results
) {

    override val binding: FragmentQuizResultsBinding by viewBinding(FragmentQuizResultsBinding::bind)
